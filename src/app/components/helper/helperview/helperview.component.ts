...
@Component({
  ...
  standalone: true,
  imports: [MatIconModule, RouterLink, NgClass, CommonModule, MatSnackBarModule, FormsModule,MatMenuModule,MatButtonModule,MatSelectModule,MatFormFieldModule, MatDialogModule],
  templateUrl: './helperview.component.html',
  styleUrl: './helperview.component.scss'
})
export class HelperviewComponent {
  constructor(private helperservice: HelperService, public router : Router, private snackBar: MatSnackBar, private dialog: MatDialog ) { }
